...
public class CharterLabelsBase extends View {
    ...
    protected CharterLabelsBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        verticalGravity = typedArray.getInt(R.styleable.Charter_c_verticalGravity, DEFAULT_VERTICAL_GRAVITY);
        horizontalGravity = typedArray.getInt(R.styleable.Charter_c_horizontalGravity, DEFAULT_HORIZONTAL_GRAVITY);
        paintLabelColor = typedArray.getColor(R.styleable.Charter_c_labelColor, getResources().getColor(R.color.default_labelColor));
        paintLabelSize = typedArray.getDimension(R.styleable.Charter_c_labelSize, getResources().getDimension(R.dimen.default_labelSize));
        typedArray.recycle();
